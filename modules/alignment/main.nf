...
process map_reads_fasta_pairs{
    ...
    */
    publishDir "${params.output_dir}/bowtie2_alignment/${sample_name}_${reference_fasta.name}", mode: 'copy'
    input:
    val sample_name
    path reads
    ...
    path "${sample_name}_${reference_fasta.name}.sorted.bam", emit: sorted_bam
    val sample_name, emit: sample_name
    val paired, emit: paired
    ...
    bowtie2 \\
        ...
        -1 ${reads[0]} \\
        -2 ${reads[1]} \\
        --threads ${task.cpus} | samtools view -bS - | samtools sort -o ${sample_name}_${reference_fasta.name}.sorted.bam
    """
