process index_bowtie2 {
    ...
    */
    publishDir "${params.output_dir}/bowtie2_index/${sample_name}", mode: params.publish_dir_mode
...
process align_bowtie2 {
    ...
    */
    publishDir "${params.output_dir}/bowtie2_alignment/${sample_name}", mode: params.publish_dir_mode
    input:
    val sample_name
    path reference_genome
    path reads
...
process convert_sam_to_bam {
    ...
    */
    publishDir "${params.output_dir}/samtools_conversion/${sample_name}", mode: params.publish_dir_mode
    input:
    path sam_file
    val sample_name
    output:
...
process sort_bam {
    ...
    */
    publishDir "${params.output_dir}/samtools_sort/${sample_name}", mode: params.publish_dir_mode
    input:
    path bam_file
    val sample_name
    output:
...
process get_unmapped_reads {
    ...
    */
    publishDir "${params.output_dir}/samtools_unmapped/${sample_name}", mode: params.publish_dir_mode
    input:
    path bam_file
    val paired
    val sample_name
...
process  get_mapped_reads{
    ...
    */
    publishDir "${params.output_dir}/samtools_mapped/${sample_name}", mode: params.publish_dir_mode
    input:
    path bam_file
    val paired
    val sample_name
...
process map_reads_fasta_pairs{
    ...
    */
    publishDir "${params.output_dir}/bowtie2_alignment/${sample_name}_${reference_fasta.baseName}", mode: params.publish_dir_mode, pattern: "*sorted.bam", enabled: params.get('roadmap_id', '') != "roadmap_5"
    publishDir "${params.output_dir}/alignment/${sample_name}", mode: params.publish_dir_mode, pattern: "*.final.bam", enabled: params.get('roadmap_id', '') == "roadmap_5"
    publishDir "${params.output_dir}/alignment/${sample_name}", mode: params.publish_dir_mode, pattern: "*.mapped*fastq.gz", enabled: params.get('roadmap_id', '') == "roadmap_5"
    publishDir "${params.output_dir}/alignment/${sample_name}", mode: params.publish_dir_mode, pattern: "*.unmapped*fastq.gz", enabled: params.get('roadmap_id', '') == "roadmap_5"
    input:
    val sample_name
    path reads
...
process index_star {
    ...
    * specified output directory.
    */
    publishDir "${params.output_dir}/star_index", mode: params.publish_dir_mode
...
process align_star {
    ...
    * is a BAM file containing the aligned reads.
    */
    publishDir "${params.output_dir}/star_alignment/${sample_name}", mode: params.publish_dir_mode
...
process index_kallisto{
    ...
    * specified output directory.
    */
    publishDir "${params.output_dir}/kallisto_index", mode: params.publish_dir_mode
    input:
...
process map_reads_kallisto_single_cell {
    ...
    * is a BAM file containing the aligned reads.
    */
    publishDir "${params.output_dir}/kallisto_alignment/${sample_name}", mode: params.publish_dir_mode
...
process map_contigs_to_reference_transcriptome{
    ...
    * is a BAM file containing the aligned reads.
    */
    publishDir "${params.output_dir}/minimap_transcriptome_alignment/", mode: params.publish_dir_mode
...
process map_rna_assemblies_to_reference_genome{
    ...
    * is a BAM file containing the aligned reads.
    */
    publishDir "${params.output_dir}/minimap_genome_alignment/", mode: params.publish_dir_mode
