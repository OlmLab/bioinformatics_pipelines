process index_bowtie2 {
    ...
    */
    publishDir "${params.output_dir}/bowtie2_index/${sample_name}"
    input:
...
process convert_sam_to_bam {
    ...
    */
    publishDir "${params.output_dir}/samtools_conversion/${sample_name}"
    input:
    path sam_file
    val sample_name
    output:
...
process sort_bam {
    ...
    */
    publishDir "${params.output_dir}/samtools_sort/${sample_name}"
    input:
    path bam_file
    val sample_name
    output:
...
process get_unmapped_reads {
    ...
    */
    publishDir "${params.output_dir}/samtools_unmapped/${sample_name}"
    input:
    path bam_file
    val paired
    val sample_name
...
process  get_mapped_reads{
    ...
    */
    publishDir "${params.output_dir}/samtools_mapped/${sample_name}"
    input:
    path bam_file
    val paired
    val sample_name
